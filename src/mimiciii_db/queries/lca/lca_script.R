...
lca_input_path <- file.path(data_dir, "lca_data.csv")
summary_path <- file.path(data_dir, "lca_k6_class_summary_all_morbidities.csv")
patient_path <- file.path(data_dir, "lca_k6_patient_level_with_class.csv")
